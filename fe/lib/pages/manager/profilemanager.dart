...
class viewProfileManager extends StatefulWidget {
  const viewProfileManager({Key? key}) : super(key: key);
  static String routeName = "/viewprofile_manager";

  @override
  _viewProfileManagerState createState() => _viewProfileManagerState();
}

class _viewProfileManagerState extends State<viewProfileManager> {
